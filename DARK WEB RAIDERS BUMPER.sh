...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing DARK WEB RAIDERS BUMPER'
    else
        figlet "DARK WEB RAIDERS BUMPER"
    fi
    ...
    echo -e "\e[1;32m           WhatsApp Group: https://chat.whatsapp.com/DO6nSWoz7ZbChnxHwRmv5S?mode=ems_copy_t \e[0m"
    echo -e "\e[4;32m   WhatsApp Channel: https://whatsapp.com/channel/0029Vb3SOvACMY0N5PlQOO3G \e[0m"
    echo " "
...
do
    ...
    echo -e "\e[4;32m   WhatsApp Group: https://chat.whatsapp.com/DO6nSWoz7ZbChnxHwRmv5S?mode=ems_copy_t \e[0m"
