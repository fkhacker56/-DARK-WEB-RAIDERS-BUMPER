...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/TheSpeedX/DARK WEB RAIDERS BUMPER/archive/dev.zip"
        dir_name = "DARK WEB RAIDERS BUMPER-dev"
    else:
        zip_url = "https://github.com/TheSpeedX/DARK WEB RAIDERS BUMPER/archive/master.zip"
        dir_name = "DARK WEB RAIDERS BUMPER-master"
    ...
    if success:
        mesgdcrt.SuccessMessage("DARK WEB RAIDERS BUMPER was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update DARK WEB RAIDERS BUMPER.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/TheSpeedX/DARK WEB RAIDERS BUMPER.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/TheSpeedX/DARK WEB RAIDERS BUMPER.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/TheSpeedX/DARK WEB RAIDERS BUMPER/master/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("DARK WEB RAIDERS BUMPER is up-to-date")
        mesgdcrt.GeneralMessage("Starting DARK WEB RAIDERS BUMPER")


def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/TheSpeedX/DARK WEB RAIDERS BUMPER/raw/dev/.notify"
        else:
            url = "https://github.com/TheSpeedX/DARK WEB RAIDERS BUMPER/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("DARK WEB RAIDERS BUMPER was created by SpeedX")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("DARK WEB RAIDERS BUMPER will work only in Python v3")
    sys.exit()
...
description = """DARK WEB RAIDERS BUMPER - Your Friendly Spammer Application

DARK WEB RAIDERS BUMPER can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

DARK WEB RAIDERS BUMPER is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by SpeedX !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start DARK WEB RAIDERS BUMPER with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start DARK WEB RAIDERS BUMPER with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start DARK WEB RAIDERS BUMPER with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update DARK WEB RAIDERS BUMPER")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current DARK WEB RAIDERS BUMPER contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current DARK WEB RAIDERS BUMPER version")
